...
public class CalDayTest{
  ...
  public void getFullInfomrationAppTest5()  throws Throwable  {
	  ...
	  // Bug Detected - 3:5PM instead of 3:05PM
	  
	  // Correct test if getFullInformationApp is not bugged >> */
	  assertEquals("4-9-2018 \n\t3:05PM Birthday Party This is my birthday party ",day.getFullInfomrationApp(day)); 
	  
	  // Bug accounted test
	  // assertEquals("4-9-2018 \n\t3:5PM Birthday Party This is my birthday party ",day.getFullInfomrationApp(day));
  }
  
  @Test(timeout = 4000) // Added in Assignment 3
  public void getFullInfomrationAppTest6_1()  throws Throwable  {
	  GregorianCalendar gc = new GregorianCalendar(2018, 3, 9);
	  CalDay day = new CalDay(gc);
	  ...
	  // Correct test if getFullInformationApp is not bugged >>
	  assertEquals("4-9-2018 \n\t12:05PM Birthday Party This is my birthday party ",day.getFullInfomrationApp(day));
	  
	  // Bug(s) accounted test
	  // assertEquals("4-9-2018 \n\t0:5AM Birthday Party This is my birthday party ",day.getFullInfomrationApp(day));
  }
  
  @Test(timeout = 4000)
  public void getFullInfomrationAppTest6_2()  throws Throwable  {
	  GregorianCalendar gc = new GregorianCalendar(2018, 3, 9);
	  CalDay day = new CalDay(gc);
	  Appt appt0 = new Appt(0, 5, 9, 4, 2018, "Birthday Party", "This is my birthday party", "xyz@gmail.com");
	  day.addAppt(appt0);
	  
	  // Bug Detected - 0:5AM instead of 0:05AM
	  
	  // Correct test if getFullInformationApp is not bugged >>
	  assertEquals("4-9-2018 \n\t12:05AM Birthday Party This is my birthday party ",day.getFullInfomrationApp(day));
	  
	  // Bug accounted test
	  // assertEquals("4-9-2018 \n\t12:5AM Birthday Party This is my birthday party ",day.getFullInfomrationApp(day));
  }
  ...
  public void getFullInfomrationAppTest7()  throws Throwable  {
	  ...
	  // Bug Detected - 3:010PM instead of 3:10PM
	  
	  // Correct test if getFullInformationApp is not bugged >>
	  assertEquals("4-9-2018 \n\t3:10PM Birthday Party This is my birthday party ",day.getFullInfomrationApp(day));
	  
	  // Bug accounted test
	  //assertEquals("4-9-2018 \n\t3:010PM Birthday Party This is my birthday party ",day.getFullInfomrationApp(day));
  }
  ...
  public void addApptTest5()  throws Throwable  {
	  ...
	  day.addAppt(appt0);
	  day.addAppt(appt1);
	  assertEquals("\t --- 5/9/2018 --- \n --- -------- Appointments ------------ --- \n\t4/9/2018 at 3:30pm ,Birthday Party, This is my birthday party\n \t4/9/2018 at 3:30pm ,Birthday Party 2, This is mom's birthday party\n \n", day.toString());
  ...
  public void addApptTest6()  throws Throwable  {
	  ...
	  day.addAppt(appt0);
	  day.addAppt(appt1);
	  assertEquals("\t --- 5/9/2018 --- \n --- -------- Appointments ------------ --- \n\t4/9/2018 at 3:30pm ,Birthday Party 2, This is mom's birthday party\n \t4/9/2018 at 5:30pm ,Birthday Party, This is my birthday party\n \n", day.toString());
	// Test takes into account of bugs from Appt
  }
